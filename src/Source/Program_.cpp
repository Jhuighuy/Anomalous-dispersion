...
//	{
//		m_Presentation = Graphics<PresentationWidget>({ STANDART_DESKTOP_WIDTH * 5 / 8, STANDART_DESKTOP_HEIGHT / 2, STANDART_DESKTOP_WIDTH * 3 / 4, STANDART_DESKTOP_HEIGHT });
//		// -----------------------
...
//					, LPCWSTR const label, auto const& min, auto& value, auto const& max, auto delta, auto i, auto j1)
//				{
...
//	* \return Exit code.
//	*/
//int CALLBACK RWinMain(_In_ HINSTANCE hInstance, _In_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine,
//	_In_ int nCmdShow)
//{
...
//	{
//		g_MainWindow.Update();
//		if (gp_AuthorsWindow) gp_AuthorsWindow->Update();
//		if (gp_PresentationWindow) gp_PresentationWindow->Update();
//	}*/
//
//	MSG msg;
